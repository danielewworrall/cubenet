...
class DiscreteModel(object):
    def __init__(self, images, n_classes, args, is_training):
        ...
        self.basis = self.get_steerable_filters(self.ks, args.max_degree, args.n_radii, args.sigma)
    ...
    def get_steerable_filters(self, kernel_size, max_degree, n_radii, sigma=1./np.pi):
